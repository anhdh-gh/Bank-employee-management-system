...
public class CreditAccount extends BankAccount{
    ...
    @PositiveOrZero(message = "DebtAmount phải là số dương or bằng 0") // tiền nợ
    private double debtAmount;

    @Column(name = "InterestRate")
    @NotNull(message = "InterestRate không được để trống!")
    @PositiveOrZero(message = "InterestRate phải là số dương or bằng 0") // lãi xuất
    ...
    public CreditAccount(String ID, Date createDate, Date editDate, MemberLevel memberLevel, String accountCode, String accountNumber, Date expireDate, String branch, BankAccountType type, boolean status, Employee employee, String CVV, double creditLimit, double debtAmount, double interestRate, Customer customer) {
